...
try:
    ...
    while fruit_1 > -11 or fruit_1 < 10 or fruit_2 > -11 or fruit_2 < 10 or fruit_3 > -11 or fruit_3 < 10: #need to look back at this later
        print ("Based on these number, I suggest you to plant " + plant_list[fruit_1] + ", " + plant_list[fruit_2] + ", and " + plant_list[fruit_3])
        break
except:
    print ("Please type a number in the range of -11 to 10")
...
def RPS():#random number (1,2,3) for rock paper scissors
...
def West():
    print ("Android: Hey, I found a shiny item. It looks like a diamond, but is not made out of CO2")
